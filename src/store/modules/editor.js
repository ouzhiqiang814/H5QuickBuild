...
const mutations = {
	 ...
	 * @param  data 
	 */
	setMusicObj(state, data) {
		state.musicUrlObj = cloneDeep(data)
	},
	/**
	 * 设定播放标识
	 * @param {} state 
	 * @param {*} data 
	 */
	setMusicPlayed(state, data) {
		state.musicFlag = cloneDeep(data)
	}
};
const getters = {
	/**
